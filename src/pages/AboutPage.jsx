...
export default function AboutPage() { return ( <main className="bg-white text-charcoal min-h-screen px-6 py-12"> <section className="max-w-5xl mx-auto"> <h1 className="text-3xl md:text-5xl font-bold text-center mb-8 text-red-primary"> About Us </h1>
