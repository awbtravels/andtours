// src/pages/HomePage.jsx import React, { useState } from "react"; import Footer from "../components/Footer";
...
{/* Desktop Menu */}
    <nav className="hidden md:flex items-center gap-6 text-sm text-charcoal font-medium">
      ...
      <a href="/team" className="hover:text-red-primary">Our Team</a>
  ...
  {isMobileMenuOpen && (
    <nav className="md:hidden px-6 py-4 bg-white shadow text-sm text-charcoal font-medium space-y-2">
      ...
      <a href="/team" className="block hover:text-red-primary">Our Team</a>
