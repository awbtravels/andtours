    ...
    <main className="bg-white text-charcoal min-h-screen font-sans">  
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white shadow-md">  
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-charcoal font-medium">  
          ...
          <a href="/team" className="hover:text-red-primary">Our Team</a> {/* Add this line */}
      ...
      {isMobileMenuOpen && (  
        <nav className="md:hidden px-6 py-4 bg-white shadow text-sm text-charcoal font-medium space-y-2">  
          <a href="/" className="block hover:text-red-primary">Home</a>  
          <a href="/consultation" className="block hover:text-red-primary">Booking Consultation</a>  
          <a href="/flights" className="block hover:text-red-primary">Flight</a>  
          <a href="/hotels" className="block hover:text-red-primary">Hotel</a>  
          <a href="/insurance" className="block hover:text-red-primary">Insurance</a>  
          ...
          <a href="/about" className="block hover:text-red-primary">About</a>  
          <a href="/team" className="block hover:text-red-primary">Our Team</a> {/* Add this line */}
      ...
      {/* FOOTER CTA */}  
      <section className="bg-charcoal text-white text-center py-4">  
        <p className="text-sm">RC: 7177769 — ...fulfilling your dream life</p>  
      </section>  
    </main>  
  );  
}
